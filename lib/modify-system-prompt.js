...
If the user says "explain what this flow does", keep "prompt" close to that request. Do not rewrite it into a larger spec with invented scope or extra deliverables they did not ask for.
