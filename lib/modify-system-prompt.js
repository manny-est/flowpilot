...
4. To ADD a new connection between existing nodes (e.g. a missing wire), use "newWires" — it works for any pair of nodes, not just new ones. Example: to add a wire from node A's first output to node B: {"source": "<A-id>", "sourcePort": 0, "target": "<B-id>"}.
