...
For example, if the user says "build me a flow that fetches weather every hour", a redirect chip's "prompt" should stay close to that request, such as "Build me a flow that fetches weather every hour." Do not rewrite it into a multi-sentence spec with invented API choices, units, or output formatting.
