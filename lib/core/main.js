    ...
    function executeApplyStepTool(args, runIdMap) {
        args = args || {};
        ...
        if (changes.length) {
            ...
            // verify step agree.
            if (propDiffs.length) { applyModifications(propDiffs, [], null, Object.assign({}, runIdMap, idMap)); }
    ...
    function executeRemoveStepTool(args, runIdMap) {
        args = args || {};
        if (!args.nodeId) {
    ...
    function executeGroupNodesTool(args, runIdMap) {
        args = args || {};
    ...
    function executeAgentToolCall(call, runIdMap) {
        ...
        switch (name) {
            ...
            case "apply_step":
                return executeApplyStepTool(args, runIdMap);
            case "remove_step":
                return executeRemoveStepTool(args, runIdMap);
            case "rename_node":
                return executeRenameNodeTool(args, runIdMap);
            case "group_nodes":
                return executeGroupNodesTool(args, runIdMap);
            case "ask_user":
