    ...
    function capabilityStatusText(p) {
        ...
        return p.supportsTools
            ? "✓ Full — this model can plan and act on your flows directly."
            : "⚠ This model can't reliably call tools, so FlowPilot asks a quick question first, then acts on your behalf.";
    }
