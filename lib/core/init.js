    ...
    function initMainWindow() {
            ...
            var content = $(
                ...
                '        actions on your flows, and adjusts itself automatically — full control when it can, ' +
                '        a safer ask-then-act mode when it can\'t. Nothing to configure here normally; an ' +
                '        override is available under Advanced for anyone who wants to force a specific mode.</div>' +
                '      <div class="fp-settings-actions">' +
