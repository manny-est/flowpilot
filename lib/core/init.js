    ...
    function initMainWindow() {
            ...
            var content = $(
                ...
                '      <select id="fp-routing-tier">' +
                '        <option value="A">A - full tool-capable planning</option>' +
                '        <option value="B">B - narrowed tools stub</option>' +
                '        <option value="C">C - classify first, then act</option>' +
                '      </select>' +
                '      <div class="fp-settings-actions">' +
