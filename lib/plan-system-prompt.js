...
const proposeActionRules = `Use propose_action only when the user's intent has become a SPECIFIC Node-RED action with identifiable target nodes from the current graph/selection, or a clear creation goal for something new.
...
CORRECT — ask_user because a key detail is missing:
User: "Clean this flow up."
Assistant calls ask_user with a concise question such as: "What kind of cleanup do you want: readability, fewer nodes, or fixing a bug?"

CORRECT — call propose_action:
