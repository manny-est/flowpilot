...
If the user says "add a debug node after this", keep "prompt" close to that request. Do not rewrite it into a larger spec with invented behavior, formatting, or extra changes.
